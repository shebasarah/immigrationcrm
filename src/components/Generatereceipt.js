    ...
    return(
      <div style={{
       ...
       onChange={e=>handleChange(e)} value={Contact_num}/>   
        ...
        <div className="row">
            <div className="col-md-6">Receipt Number</div>
            <div className="col-md-6">
                ...
                onChange={e=>handleChange(e)} value={invoicenumber}>
                    ...
                    <option value="Receipt 1" >Receipt 1</option>
                    <option value="Receipt 2">Receipt 2</option>
