    ...
    <PDFViewer style={styles.viewer}>
      ...
      <Document>
        ...
        <View style={styles.heading}>
            <Text style={{ fontFamily: 'Times-Bold' }}>RECEIPT</Text>
          ...
          <Text style={{fontFamily: 'Times-Bold',fontSize:10  }}>PAYEE </Text>
           ...
           <Text style={{fontFamily:'Times-Bold',fontSize:10   }}>PAYMENT DETAILS </Text>
            ...
            <Text>Receipt name:{location.state.invoicenumber}</Text>
            <Text>Receipt number:645378ADG</Text>
            <Text>Receipt date: {date}</Text>
            <Text>--------------------------------------------------------------------------------------</Text>
            ...
            <Text>Total amount paid (NZD): {location.state.total}</Text> 
            <Text>--------------------------------------------------------------------------------------</Text>
            <Text style={{fontFamily: 'Times-Bold' ,fontSize:25}}>PAYMENT RECEIVED</Text>
            <Text>--------------------------------------------------------------------------------------</Text>
