...
const Login_admin=()=>{
    ...
    const submitForm=(e)=>{
       ...
       // console.log(sendData);
        ...
        axios.post('http://localhost/immigrationcrm_react-php/adminlogin.php',sendData)
        .then((result)=>{
            //console.log(result);
            if (result.data.status === 'Valid') { 
                alert("Welcome!");
              navigate(`/dashboard-admin`,{state:{id:user.id}});  
            }
        else  {
    ...
    return(
        ...
        <div className="main-box">
            <div className="row">
                <div className="col-md-12 text-center"><h1>Admin Login Page</h1></div>
        </div>
